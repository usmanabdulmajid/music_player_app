                      ...
                      onTap: () {
                        Navigator.push(context,
                          ...
                          return CategorySongScreen(
                            dataModel: flutterAudioQuery.getSongsFromArtist(
                                artistId: artistInfo.id),
                          );
                        }));
                      },
                      leading: (artistInfo.artistArtPath != null)
                          ? Image.file(File(artistInfo.artistArtPath))
                          : FutureBuilder(
                              future: flutterAudioQuery.getArtwork(
                                  type: ResourceType.ARTIST, id: artistInfo.id),
                              builder: (context, snapshot) {
                                    ...
                                    errorBuilder: (context, o, n) {
                                      return ClipRRect(
                                        borderRadius: BorderRadius.all(
                                            Radius.circular(200)),
                                        child: Image.asset(
                                          "assets/images/person-icon-8.png",
                                          height: 49.0,
                                          width: 49.0,
                                          fit: BoxFit.cover,
                                        ),
